# Generated by Django 5.2.4 on 2025-08-03 02:15
    ...
    operations = [
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        ...
                        default="",
                        editable=False,
                        help_text="DEPRECATED: Use connection.refresh_token",
                        max_length=255,
                    ),
                ),
                (
                    ...
                    models.CharField(
                        ...
                        default="",
                        editable=False,
                        help_text="DEPRECATED: Use connection.access_token",
                        max_length=255,
                    ),
                ),
                (
                    ...
                    models.DateTimeField(
                        blank=True,
                        help_text="DEPRECATED: Use connection.token_expires_at",
                        null=True,
                    ),
                ),
                (
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "expires_at",
                    models.DateTimeField(
                        help_text="Token expiration date (1 year from creation)"
                    ),
                ),
            ],
            options={
                ...
                "indexes": [
                    models.Index(fields=["token"], name="core_google_token_9c4c4f_idx"),
                    models.Index(fields=["name"], name="core_google_name_de0566_idx"),
                    models.Index(
                        fields=["expires_at"], name="core_google_expires_d93055_idx"
                    ),
                ],
            },
        ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.PositiveIntegerField(
                        default=100, help_text="Concurrent calls per agent"
                    ),
                ),
                (
                    "token",
            ...
            options={
                ...
                "indexes": [
                    models.Index(fields=["token"], name="core_liveki_token_64f5d1_idx"),
                    models.Index(fields=["name"], name="core_liveki_name_167fd8_idx"),
                    models.Index(
                        fields=["expires_at"], name="core_liveki_expires_383b65_idx"
                    ),
                ],
            },
        ),
