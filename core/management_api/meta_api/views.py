...
class MetaWebhookView(viewsets.ViewSet):
    ...
    def oauth_hook(self, request):
        ...
        try:
            ...
            return redirect('/dashboard/meta-integration?meta_connected=true')
    ...
    def _process_lead_data(self, lead_data):
        ...
        try:
            ...
            if lead:
                ...
                # Lead was ignored (no active agent/funnel or invalid fields)
                logger.info(f"Lead {leadgen_id} ignored - no active agent/funnel or invalid fields")
                return {
                    'lead_id': None,
                    'meta_leadgen_id': leadgen_id,
                    'form_id': form_id,
                    'workspace': str(meta_integration.workspace.id),
                    'status': 'ignored_invalid_fields'
                }
