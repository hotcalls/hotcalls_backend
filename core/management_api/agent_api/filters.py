...
class AgentFilter(django_filters.FilterSet):
    ...
    script_template = django_filters.CharFilter(lookup_expr='icontains')
    ...
    class Meta:
        model = Agent
        fields = ['workspace', 'name', 'status', 'voice', 'language', 'retry_interval', 'character', 'script_template']
    ...
    def filter_search(self, queryset, name, value):
        ...
        return queryset.filter(
            ...
            models.Q(script_template__icontains=value) |
